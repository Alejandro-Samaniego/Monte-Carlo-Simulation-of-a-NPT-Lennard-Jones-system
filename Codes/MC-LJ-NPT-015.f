...
c
      open(3,file='thermodynamics_P_015.dat',status='unknown')
      open(4,file='gr_P_015.dat',status='unknown')
      open(5,file='last_config_P_015.dat',status='unknown')
